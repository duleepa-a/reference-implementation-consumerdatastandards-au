...
class AUConstants extends Constants {
    ...
    public static final String testJointAccountID = "6500001232"
    ...
    public static final String TOKEN_REVOKE_PATH = "/oauth2/revoke"
        ...
        public static final String ACCOUNT_METADATA_CONTEXT = "/ob/cds/account-metadata"
    // CONSENT_STATUS_AU_ENDPOINT kept as empty so legacy concatenations ("${CONSENT_STATUS_AU_ENDPOINT}${X}") still resolve
    public static final String CONSENT_STATUS_AU_ENDPOINT = ""
        public static final String UPDATE_BUSINESS_USER = ACCOUNT_METADATA_CONTEXT + "/business-stakeholders"
    ...
    public static final String CONSENT_SEARCH_ENDPOINT = "/api/openbanking/consent/admin/search"
        ...
        public static final String UPDATE_LEGAL_ENTITY_SHARING_STATUS = ACCOUNT_METADATA_CONTEXT + "/legal-entity"

...
class AUPageObjects {
    ...
    public static String SINGLE_ACCOUNT_XPATH = "(//input[@name='accounts'])[1]"
    public static String ALT_SINGLE_ACCOUNT_XPATH = "(//input[@name='accounts'])[2]"
    ...
    public static String CHK_ORG_A_BUSINESS_ACCOUNT_1 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'business_account_1')]"
    public static String CHK_ORG_B_BUSINESS_ACCOUNT_1 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'business_account_2')]"
    public static String CHK_ORG_B_BUSINESS_ACCOUNT_2 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'business_account_3')]"
    public static String SECONDARY_ACCOUNT_1 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_account_1')]"
    public static String SECONDARY_ACCOUNT_2 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_account_2')]"
    ...
    public static String SECONDARY_JOINT_ACCOUNT = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_joint_account_1')]"
    public static String LBL_SECONDARY_ACCOUNT_1 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_account_1')]/.."
    public static String LBL_SECONDARY_ACCOUNT_2 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_account_2')]/.."
    public static String LBL_SECONDARY_ACCOUNT_3 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_account_3')]/.."
    public static String LBL_SECONDARY_JOINT_ACCOUNT_1 = "//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'secondary_joint_account_1')]/.."
    ...
    public static String JOINT_ACCOUNT_XPATH = "(//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'joint_account')])[1]"
    public static String JOINT_ACCOUNT_2_XPATH = "(//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'joint_account_2')])"
    public static String ALT_JOINT_ACCOUNT_XPATH = "(//input[@name='accounts' and starts-with(translate(@id, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), 'joint_account')])[2]"
